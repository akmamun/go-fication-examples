...
type ExampleRepo interface {
	...
	UpdateExample(id int, exp *models.Example) (err error)
}
...
func (r *GormRepository) UpdateExample(id int, exp *models.Example) (err error) {
	query := models.Example{Id: id}
	err = r.db.Database.Model(&query).Updates(&exp).Error
	return
}
